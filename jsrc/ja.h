...
#define fullnamenpy(x)              jtfullnamenpy(jt,(x))
...
#define jfappend(x,y)               jtjfappend(jt,(x),(y))
...
#define npydescr(x)                 jtnpydescr(jt,(x))
#define npyshape(x)                 jtnpyshape(jt,(x))
...
#define strln(x,y)                  jtstrln(jt,(x),(y))
